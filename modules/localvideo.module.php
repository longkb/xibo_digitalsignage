...
//         $dir = Kit::GetParam('uri', _POST);
//         require_once('/home/longkb/getID3-master/getid3/getid3.php');
//         $getID3=new getID3;
//         $file=$getID3->analyze($dir);
//         $timeTemplate=1;
//         $t=explode(':',$file['playtime_string']);
//         $dura=0;
//         for($i=count($t)-1;$i>=0;$i--){
//         	$dura=$dura+intval($t[$i])*$timeTemplate;
//         	$timeTemplate=$timeTemplate*60;
//         }
